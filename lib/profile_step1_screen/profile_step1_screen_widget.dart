...
class ProfileStep1ScreenWidget extends StatefulWidget {
  const ProfileStep1ScreenWidget({Key key}) : super(key: key);

  @override
  _ProfileStep1ScreenWidgetState createState() =>
      _ProfileStep1ScreenWidgetState();
}

class _ProfileStep1ScreenWidgetState extends State<ProfileStep1ScreenWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'profile_step1_screen'});
  }
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'sfga0h32' /* Fill out your dog profiles bel... */,
                            ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'aa4renl3' /* You can add multiple pups in y... */,
                            ),
