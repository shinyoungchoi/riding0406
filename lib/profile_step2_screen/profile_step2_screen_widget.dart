...
class ProfileStep2ScreenWidget extends StatefulWidget {
  const ProfileStep2ScreenWidget({Key key}) : super(key: key);

  @override
  _ProfileStep2ScreenWidgetState createState() =>
      _ProfileStep2ScreenWidgetState();
}

class _ProfileStep2ScreenWidgetState extends State<ProfileStep2ScreenWidget> {
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'profile_step2_screen'});
  }
                    ...
                    child: Row(
                      ...
                      children: [
                        Expanded(
                          child: Text(
                            FFLocalizations.of(context).getText(
                              'fhuwh23j' /* Fill out your dog profiles bel... */,
                            ),
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Text(
                            FFLocalizations.of(context).getText(
                              'ckxd2tci' /* You can add multiple pups in y... */,
                            ),
